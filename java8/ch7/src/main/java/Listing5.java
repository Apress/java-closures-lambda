...
public class Listing5 {
  ...
  public static void main(String[] args) {
    ...
    ResourceExceptionHandler handler = new ResourceExceptionHandler(Listing5::generateInputStream);

    // Perform the stream processing
    Function<Integer, Stream<Integer>> flatMapFunction = handler.map(generateMap());
